...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    // implemented, and the local projection matrix.
    {
        ...
        modelMatrix = glm::rotate(modelMatrix, RADIANS(45.f), glm::vec3(1.f, 2.f, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(2.f, .25f, .6f));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(3.f, 2.f, 1.f));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(90.f), glm::vec3(0.8f, 0, 0.5f));
